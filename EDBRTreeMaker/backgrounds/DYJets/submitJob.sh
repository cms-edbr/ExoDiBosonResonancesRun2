...
#            bsub -q 8nh -M 5000 -J DY600ac < submitJob.sh

export X509_USER_PROXY=/afs/cern.ch/user/j/jruizvar/x509up_u9472
cd /afs/cern.ch/work/j/jruizvar/private/Summer15/25ns/CMSSW_7_4_12/src/ExoDiBosonResonances/EDBRTreeMaker/backgrounds/DYJets
