...
sed -i '20 s/200to400-ac/200to400-ad/' submitJob.sh; bsub -q 8nh -M 2000 -J DY200ad < submitJob.sh
sed -i '20 s/200to400-ad/200to400-ae/' submitJob.sh; bsub -q 8nh -M 2000 -J DY200ae < submitJob.sh
sed -i '20 s/200to400-ae/200to400-af/' submitJob.sh; bsub -q 8nh -M 2000 -J DY200af < submitJob.sh
sed -i '20 s/200to400-af/400to600-aa/' submitJob.sh; bsub -q 8nh -M 2000 -J DY400aa < submitJob.sh
