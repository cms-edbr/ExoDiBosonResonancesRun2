...
#            bsub -q 8nh -M 2000 -J TTbg < submitJob.sh

export X509_USER_PROXY=/afs/cern.ch/user/j/jruizvar/x509up_u9472
cd /afs/cern.ch/work/j/jruizvar/private/Fall15/25ns/CMSSW_7_4_12_patch4/src/ExoDiBosonResonances/EDBRTreeMaker/backgrounds/TTbar
