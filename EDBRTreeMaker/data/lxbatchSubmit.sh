...
#            bsub -q 1nd -M 5000 -J job1 < lxbatchSubmit.sh

export X509_USER_PROXY=/afs/cern.ch/user/j/jruizvar/x509up_u9472
cd /afs/cern.ch/work/j/jruizvar/private/Summer15/25ns/CMSSW_7_4_12/src/ExoDiBosonResonances/EDBRTreeMaker/data

eval `scramv1 runtime -sh`

cmsRun analysis-SingleElectron_Run2015C.py
#cmsRun analysis-SingleMuon_Run2015C.py
