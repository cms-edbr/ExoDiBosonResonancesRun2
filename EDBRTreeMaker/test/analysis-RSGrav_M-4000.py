...
process.treeDumper = cms.EDAnalyzer("EDBRTreeMaker",
                                    ...
                                    crossSectionPb = cms.double(0.0001357),
...
### Source
process.load("ExoDiBosonResonances.EDBRCommon.simulation.RSGravToZZ_kMpl01_M-4000_PHYS14")
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("treeEDBR_RSGravToZZ_kMpl01_M-4000.root")
                                   )
