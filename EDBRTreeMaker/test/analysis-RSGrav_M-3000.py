...
process.treeDumper = cms.EDAnalyzer("EDBRTreeMaker",
                                    originalNEvents = cms.int32(29209),
                                    crossSectionPb = cms.double(0.001454),
...
### Source
process.load("ExoDiBosonResonances.EDBRCommon.simulation.RSGravToZZ_kMpl01_M-3000_PHYS14")
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("treeEDBR_RSGravToZZ_kMpl01_M-3000.root")
                                   )
